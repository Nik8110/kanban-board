...
import '../services/theme/notification_service.dart';
import '../views/today_task_view.dart';
...
class HomeController extends GetxController {
  ...
  addTask() async {
    ...
    tempTask!.taskTitle = taskTitleController!.text;
    tempTask!.taskDesc = taskDescriptionController!.text;
